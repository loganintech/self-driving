...
if("TRUE" STREQUAL "TRUE")
  set(mavros_SOURCE_PREFIX /home/nvidia/Dev/workspace/src/mavros/mavros)
...
if(NOT "/home/nvidia/Dev/workspace/src/mavros/mavros/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(mavros_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/Dev/workspace/src/mavros/mavros/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/Dev/workspace/src/mavros/mavros/${idir}'.  ${_report}")
    endif()
