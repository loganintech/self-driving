...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/nvidia/Dev/workspace/src/mavros_cloned/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/nvidia/Dev/workspace/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/nvidia/Dev/workspace/install)
...
if(NOT "/home/nvidia/Dev/workspace/src/mavros_cloned/libmavconn/include;/usr/include;/opt/ros/melodic/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/Dev/workspace/src/mavros_cloned/libmavconn/include;/usr/include;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/Dev/workspace/src/mavros_cloned/libmavconn/${idir}'.  ${_report}")
    endif()
