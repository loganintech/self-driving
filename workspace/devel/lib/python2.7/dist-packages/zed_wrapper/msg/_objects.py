...
"""autogenerated by genpy from zed_wrapper/objects.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import zed_wrapper.msg
import geometry_msgs.msg
import std_msgs.msg

class objects(genpy.Message):
  _md5sum = "f74a9cc2a8c886c042be0d913eabb9fd"
  _type = "zed_wrapper/objects"
...
float64 z"""
  __slots__ = ['objects']
  _slot_types = ['zed_wrapper/object_stamped[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = zed_wrapper.msg.object_stamped()
        _v5 = val1.header
        start = end
        end += 4
